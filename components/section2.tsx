...
const timelineData: TimelineData[] = [
  ...
  },
  {
    ...
    type: "Internship",
    description: "Contributed to backend services and internal platform tooling by supporting API development, database optimization, and cloud-based service integrations while collaborating with senior engineers.",
    points: ["Assisted by backend developers for Messenger and Payment services, implementing audit logging and running database optimization scripts.", "Supported Offer Service and Entitlement SDK development by integrating frontend logic and performing cache validation for service reliability.", "Collaborated with senior engineers on API development, cloud integrations, and system scalability improvements across internal service infrastructure."],
    tech: ["React", "S3", "Redis"],
  },
  {
    id: 'medanta',
